		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Marketplace",
									"targetURL": "#comsapmarketplaceproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmarketplaceproject-display": {
								"semanticObject": "comsapmarketplaceproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.marketplaceproject",
									"url": sap.ui.require.toUrl("com/sap/marketplaceproject")
								}
							}
						}
					}
